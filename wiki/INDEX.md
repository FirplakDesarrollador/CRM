...
- [sincronizacion-offline](pages/sincronizacion-offline.md) — SyncEngine local-first: push/pull desacoplados, Outbox recuperable, cursores durables, paginación, catálogos con TTL, LWW y telemetría.
