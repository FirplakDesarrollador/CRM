---
description: Commit y push en rama alejo. Validar compilación en GitHub y build de preview en Vercel. Fusionar (merge) alejo_nueva con main mediante Pull Request. Confirmar el despliegue final de producción en Vercel.
---

# Workflow: Despliegue a Main desde Rama `alejo_nueva`
...
## Prerrequisitos
- Estar en la rama de desarrollo `alejo_nueva`.
...
### Paso 2: Validar Build de Preview (Rama `alejo_nueva`)
...
2. **Vercel**: 
   ...
   - Localiza el deployment generado para la rama `alejo_nueva`.
...
Una vez comprobado que el build en la rama `alejo_nueva` funciona perfectamente:
1. Crea un **Pull Request** desde `alejo_nueva` hacia `main` en GitHub.
