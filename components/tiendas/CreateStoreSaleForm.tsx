                                                ...
                                                searchResults.map((product: PriceListProduct) => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className="w-full text-left px-3 py-2.5 sm:px-3.5 sm:py-2 hover:bg-slate-50 active:bg-slate-100 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-between gap-2 border-b last:border-0 transition-colors cursor-pointer group"
                                                        >
                                                            ...
                                                            <div className="shrink-0 text-right">
                                                                <span className="text-[11px] sm:text-xs font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-100 whitespace-nowrap">
                                                                    COP {new Intl.NumberFormat('es-CO', { maximumFractionDigits: 0 }).format(Math.round(displayPrice))}
                                                                </span>
                                                            </div>
                                                        </button>
                                                    );
