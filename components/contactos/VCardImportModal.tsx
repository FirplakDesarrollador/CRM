        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
            <div className="bg-white rounded-lg shadow-xl w-full max-w-md border border-slate-200">
                <div className="flex justify-between items-center p-4 border-b border-slate-200">
                    <h3 className="text-lg font-semibold text-slate-800">Importar Contacto</h3>
                ...
                <div className="p-6 space-y-4">
                    {showNativeOption && (
                        <>
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-2 p-3 bg-blue-50 text-blue-700 rounded-lg border border-blue-200 hover:bg-blue-100 transition-colors"
                            >
                    ...
                    >
                        <div className="flex flex-col items-center justify-center pt-5 pb-6 text-center">
                            ...
                            <p className="text-xs text-slate-500">Archivos .VCF (vCard)</p>
                        </div>
                        <input
                            ref={inputRef}
                            type="file"
                    ...
                    {(localError || hookError) && (
                        <div className="mt-4 p-3 bg-red-50 text-red-600 text-sm rounded flex items-start gap-2">
