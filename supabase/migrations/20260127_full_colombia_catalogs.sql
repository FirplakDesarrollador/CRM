-- Migration: Full Colombian Catalogs
-- Generated on 2026-01-27T03:21:38.021Z

BEGIN;

-- Clean up existing data to avoid name/ID conflicts
-- First, set references to NULL in main tables to avoid FK violations during cleanup
UPDATE "CRM_Cuentas" SET departamento_id = NULL, ciudad_id = NULL;
UPDATE "CRM_Oportunidades" SET departamento_id = NULL, ciudad_id = NULL;

DELETE FROM "CRM_Ciudades";
DELETE FROM "CRM_Departamentos";

-- Insert Departments
INSERT INTO "CRM_Departamentos" (id, nombre) VALUES
(5, 'Antioquia'),
(8, 'Atlántico'),
(11, 'Bogotá D.C.'),
(13, 'Bolívar'),
...
-- Insert Cities
INSERT INTO "CRM_Ciudades" (id, departamento_id, nombre) VALUES
(5001, 5, 'Medellín'),
(5002, 5, 'Abejorral'),
(5004, 5, 'Abriaquí'),
(5021, 5, 'Alejandría'),
...
SELECT setval(pg_get_serial_sequence('"CRM_Departamentos"', 'id'), coalesce(max(id), 1)) FROM "CRM_Departamentos";
SELECT setval(pg_get_serial_sequence('"CRM_Ciudades"', 'id'), coalesce(max(id), 1)) FROM "CRM_Ciudades";
