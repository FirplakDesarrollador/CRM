-- =============================================================================
-- MIGRATION: 20260911_add_origin_to_sales_funnel.sql
-- Modify get_sales_funnel_data RPC to support filtering by origen_oportunidad
-- =============================================================================
...
CREATE OR REPLACE FUNCTION get_sales_funnel_data(
    ...
    p_origen_oportunidad TEXT DEFAULT NULL
)
RETURNS TABLE (
    fase_id INT,
    fase_nombre TEXT,
    ...
    IF p_canal_id IS NOT NULL THEN
        ...
        FilteredOpps AS (
            ...
            WHERE 
                ...
                AND (p_origen_oportunidad IS NULL OR o.origen_oportunidad = p_origen_oportunidad)
        )
        SELECT 
            cp.cp_id as fase_id,
